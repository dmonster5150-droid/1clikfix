  ...
  return (
    <div className="container">
      <div style={{textAlign:'center', padding:'48px 0'}}>
        <h1 style={{fontSize:30, margin:0}}>Welcome to <span style={{fontWeight:700}}>🧰 1clikfix.com</span></h1>
        ...
        <p style={{color:'#999', fontSize:13, marginTop:18}}>Providers must subscribe via Square, then create an account and profile to access calendar and jobs.</p>
      </div>
    </div>
  );
}
